...
<blockquote class="layui-elem-quote layui-quote-nm layui-hide" id="footer">layui 提供强力驱动</blockquote>
...
layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
  ...
  table.render({
    elem: '#demo'
    ,height: 420
    ,url: '/ybPfAdmin/admin/distr/create' //数据接口
    ,title: '用户表'
    ,page: true //开启分页
    ...
    ,cols: [[ //表头
              ...
              ,{field: 'name', title: '仓名', width:80}
              ,{field: 'barn_id', title: '仓id', width: 90, sort: true, totalRow: true},
